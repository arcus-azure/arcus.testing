...
🔗 See the [feature documentation](../03-Features/04-Technology/06-Integration/01-data-factory.mdx) for more information on testing DataFactory functionality.
...
🔗 See the [feature documentation](../03-Features/04-Technology/04-Storage/01-storage-account.mdx) for more information on interacting with Blob storage.
...
🔗 See the [feature documentation](../03-Features/04-Technology/04-Storage/01-storage-account.mdx) for more information on interacting with Table storage.
...
🔗 See the [feature documentation](../03-Features/04-Technology/04-Storage/02-cosmos.mdx) for more information on interacting with Cosmos NoSql storage.