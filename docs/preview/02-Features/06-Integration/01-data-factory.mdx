...
> ⚠️ **IMPORTANT** to note on the `GetDataAs...()` calls is that the DataFactory data preview functionality does not support the full format of all types of file formats. Therefor, take these warnings in consideration.
