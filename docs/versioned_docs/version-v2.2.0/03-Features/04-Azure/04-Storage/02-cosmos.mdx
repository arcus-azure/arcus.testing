...
# Cosmos DB
The `Arcus.Testing.Storage.Cosmos` package provides test fixtures for Azure Cosmos DB storage. By using the common test practices 'clean environment', it provides temporary collections and documents.
